...
function getEmailFCK()
{
    ...
    //$f = fopen("cok.txt", "w");
    //fprintf($f, $_COOKIE['PHPSESSID']);

    $ckname = 'conlivefck_cookie';
...
function ServerMapFolder( $resourceType, $folderPath, $sCommand )
{
    ...
    $f = fopen("sfolder.txt", "w");
    fprintf($f, "$sResourceTypePath");
